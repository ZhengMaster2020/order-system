export default [
  { name: 'production-plan-management/production-plan-list', title: '编辑计划' },
  { name: 'production-plan-management/production-plan-execute', title: '执行计划' },
  { name: 'outbound-management/outbound-add', title: '编辑出库单' },
